...
CREATE TABLE ro_passport (
    ...
    pas_series varchar(10) not null,
...
CREATE TABLE ro_marriage_certificate (
    ...
    mc_active boolean DEFAULT false,
    end_date date,
...
INSERT INTO ro_passport (person_id, pas_series, pas_number, date_issue, issue_department)
VALUES (1, '40000', '123456', '2018-04-10', 'Passport Department');

INSERT INTO ro_birth_certificate (cer_number, date_issue, person_id, mother_id, father_id)
VALUES ('123 Birth', '2018-01-01', 3, 1, 2);